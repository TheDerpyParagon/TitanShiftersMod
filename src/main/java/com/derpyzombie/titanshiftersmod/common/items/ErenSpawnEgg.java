...
public class ErenSpawnEgg extends SpawnEggItem {

	protected static final List<ErenSpawnEgg> UNADDED_EGGS = new ArrayList<>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public ErenSpawnEgg(final RegistryObject<? extends EntityType<?>> entityTypeSupplier,
